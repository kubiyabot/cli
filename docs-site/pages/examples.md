...
steps:
  ...
  - name: send_alert
    ...
    depends_on: [check_services, check_resources, check_disk_space, check_memory, check_network]
```
...
steps:
  ...
  - name: create_dashboard
    ...
    depends_on: [collect_application_logs, analyze_error_patterns, check_error_rate]
```
